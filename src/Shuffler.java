...
public class Shuffler {
    ...
    public static void perfectShuffle(int[] values) {
         ...
         * (initially the entire deck). It repeatedly does the following until
         * all cards have been selected: randomly remove a card from those not
         * yet selected and add it to the selected cards. An efficient version
         * of this algorithm makes use of arrays to avoid searching for an
         * as-yet-unselected card.
         *
         * @param values is an array of integers simulating cards to be
         * shuffled.
         */
